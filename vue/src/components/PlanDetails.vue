  ...
  <div class = 'plan-details'>
    <div class="background">
      <form v-on:submit.prevent="saveBase" class='form-plan'>
        ...
        <input name="plan-name" type="text" class='plan-name' v-model="floorPlan.planName" />
        <label for="State" class='state'>Select State:</label>
        <select name="state" v-model="floorPlan.state" required v-on:change="viewRange">
          <option value="Ohio">OH</option>
        </select>
        <label for="City" class='city'>Select City:</label>
        <select name="city" v-model="floorPlan.city" required v-on:change="viewRange">
        ...
        <select name="house-types" v-model="floorPlan.houseType" v-on:change="viewRange">
          <option value="single_family">Single-Family</option>
          <option value="multi_family">Multi-Family</option>
          <option value="land">Empty Lot</option>
        </select>
        <label for="square-foot" class='size'>Select Minimum Square Footage:</label>
        <select v-if="floorPlan.houseType !== 'land'" name="square-foot" v-model="floorPlan.squareFootage" v-on:change="viewRange" required >
